        ...
        <div className="rounded-card border border-edge bg-surface p-5 shadow-card">
          ...
          <form onSubmit={onSearch} className="mt-3 flex gap-2">
            <input
              ...
              className="w-full max-w-md rounded-btn border border-edge bg-white px-3.5 py-2.5 text-sm text-brand-text outline-none focus:border-primary focus:ring-2 focus:ring-primary/15"
            />
